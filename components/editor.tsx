...
export function Editor({ content, onChange }: EditorProps) {
  ...
  return (
    <div className="border rounded-lg bg-background flex flex-col">
      {/* Editor content area */}
      <div className="bg-background rounded-t-lg flex-1">
        <EditorContent editor={editor} />
      </div>

      {/* Toolbar - sticky at bottom, responsive layout */}
      <div
        className="sticky bottom-0 z-10 border-t bg-background/95 p-1.5 sm:p-2 backdrop-blur-sm rounded-b-lg supports-[backdrop-filter]:bg-background/60"
        role="toolbar"
